...
@pytest.mark.parametrize('metric',['headcount','hires','departures','turnover_rate','avg_tenure','attendance_rate','late_count','late_rate','abnormal_count','approved_overtime_hours','late_departure_hours','avg_work_hours','leave_days'])
