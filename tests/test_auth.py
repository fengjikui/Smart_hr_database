...
from backend.hr import auth, config, store
from backend.hr.schema import FIELDS, Plan
...
def test_only_question_and_relation_fields():
    cases = json.loads((config.PROJECT / "evaluation/cases.json").read_text())["cases"]
