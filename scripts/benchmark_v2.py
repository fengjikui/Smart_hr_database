"""Small, serial V2 benchmark using isolated state; never invokes the model."""
...
from backend.hr.v2 import service, store
...
def main():
    ...
    times = []
    with tempfile.TemporaryDirectory(prefix="hr-v2-benchmark-") as folder:
    ...
    Path("reports/demo-v2-performance.json").write_text(
